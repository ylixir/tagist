...
var _ylixir$tagist$Main$Model = function (a) {
	return {filters: a};
};
...
var _ylixir$tagist$Main$modelFromLocation = function (location) {
	return _ylixir$tagist$Main$Model(
...
var _ylixir$tagist$Main$init = function (location) {
	return {
		ctor: '_Tuple2',
		_0: _ylixir$tagist$Main$modelFromLocation(location),
...
var _ylixir$tagist$Main$update = F2(
	function (msg, model) {
		...
		return {
			ctor: '_Tuple2',
			_0: _ylixir$tagist$Main$modelFromLocation(_p10._0),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
...
if (typeof _ylixir$tagist$Main$main !== 'undefined') {
    _ylixir$tagist$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"UrlChange":["Navigation.Location"]}}},"aliases":{"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
